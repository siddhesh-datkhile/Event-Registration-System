...
export function EventCard({ event, actionSlot }: EventCardProps) {
  ...
  return (
    <div className={`relative flex flex-col rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md ${isClosed ? 'opacity-60 grayscale-[0.2]' : ''}`}>
      {/* Status + Seats */}
