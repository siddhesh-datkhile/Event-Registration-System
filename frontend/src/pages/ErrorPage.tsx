...
export default function ErrorPage() {
  ...
  return (
    <div className='flex min-h-[80vh] flex-col items-center justify-center px-4 py-12'>
      <div className='flex max-w-lg flex-col items-center rounded-3xl border border-slate-200 bg-slate-50 p-10 text-center shadow-lg'>
        <div className='mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-white text-slate-400'>
