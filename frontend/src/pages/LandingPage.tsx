      ...
      <section className='py-14'>
        <div className='grid items-center gap-10 md:grid-cols-2'>
          ...
          <div className='relative'>
            <div className='absolute -inset-6 -z-10 rounded-[2rem] bg-indigo-50 blur-2xl' />
            <div className='rounded-2xl border border-slate-200 bg-white p-6 shadow-sm'>
              <div className='flex items-center justify-between'>
                <div>
                  <div className='text-sm font-semibold text-slate-700'>Today&apos;s Quick View</div>
                  <div className='mt-1 text-2xl font-bold'>Upcoming Events</div>
                </div>
                <div className='rounded-xl bg-indigo-600/10 px-3 py-1 text-sm font-semibold text-indigo-700'>
                  Live
                </div>
              </div>
              ...
              <div className='mt-5 space-y-3'>
                {[
                  ...
                  >
                    ...
                    <div className='text-sm font-semibold text-slate-800'>{e.seats}</div>
                  </div>
                ))}
              </div>
      ...
      <section id='how-it-works' className='py-10'>
        ...
        <div className='mt-8 grid gap-5 md:grid-cols-3'>
          {[
            ...
            >
              <div className='text-sm font-semibold text-indigo-700'>Step {idx + 1}</div>
      ...
      <section className='py-10'>
        ...
        <div className='mt-8 grid gap-5 md:grid-cols-2'>
          {[
            ...
            <div key={event.title} className='rounded-2xl border border-slate-200 bg-white p-6'>
              <div className='flex items-center justify-between gap-3'>
                <div className='text-sm font-semibold text-indigo-700'>{event.tag}</div>
                <div className='rounded-full bg-indigo-600/10 px-3 py-1 text-xs font-semibold text-indigo-700'>
                  Open
                </div>
              </div>
              ...
              <div className='mt-5'>
                <Link
                  to='/register'
                  className='inline-flex items-center justify-center rounded-lg border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-800 hover:bg-slate-50'
                >
                  Register interest
                </Link>
              </div>
      ...
      <section className='py-10'>
        <div className='rounded-3xl border border-slate-200 bg-gradient-to-b from-indigo-50 to-white p-8 md:p-10'>
          ...
          <div className='mt-7 flex flex-wrap gap-3'>
            ...
            <Link
              to='/login'
              className='inline-flex items-center justify-center rounded-lg border border-slate-300 px-6 py-3 text-sm font-semibold text-slate-800 hover:bg-slate-50'
            >
              Login
            </Link>
          </div>
