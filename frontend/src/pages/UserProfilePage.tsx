        ...
        <div className='relative px-6 pb-8 sm:px-10'>
          <div className='-mt-12 mb-6 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4'>
            ...
            <div className='flex items-center gap-3'>
              <span className='inline-flex items-center rounded-full bg-indigo-50 px-3 py-1 text-sm font-semibold text-indigo-700 border border-indigo-200'>
          ...
          {isEditing ? (
            <form onSubmit={handleSubmit} className='mt-8 flex flex-col gap-6'>
              <div className='grid gap-6 sm:grid-cols-2'>
                <div>
                  ...
                  <input
                    ...
                    className='mt-1 block w-full rounded-lg border-slate-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2.5 border'
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled
                    value={profile.email}
                    className='mt-1 block w-full rounded-lg border-slate-300 bg-slate-100 text-slate-500 shadow-sm sm:text-sm p-2.5 border cursor-not-allowed'
                  />
                </div>
              ...
              <div className='flex justify-end pt-4 border-t border-slate-100'>
                <button
                  type='submit'
                  disabled={saving}
                  className='inline-flex items-center rounded-lg bg-indigo-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-700 disabled:opacity-50'
                >
            ...
            <div className='mt-8 grid gap-6 sm:grid-cols-2'>
              <div className='flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50 p-4'>
                <Mail className='mt-0.5 h-5 w-5 text-indigo-500' />
                <div>
              ...
              <div className='flex items-start gap-3 rounded-xl border border-slate-100 bg-slate-50 p-4'>
                <Phone className='mt-0.5 h-5 w-5 text-indigo-500' />
                <div>
